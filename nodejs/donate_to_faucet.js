...
const execute = async () => {
    ...
    sendDonation(faucet, name, ethers.utils.toUtf8Bytes(country), ethers.utils.parseEther(spendeToFaucetInETH).toString(), waitForConfirmations)
        .catch((e) => {
...
// donorCountry must be an hex array, eg from ethers.utils.toUtf8Bytes("🇦🇹")
